...
class test_ktx_app : public base_obj_viewer_app
{
public:
    test_ktx_app(const char* app_name);
...
private:
    ...
    vk_utils::graphics_pipeline_handler m_skybox_pipeline{};
    vk_utils::shader_module_handler m_skybox_vert_shader{};
    vk_utils::shader_module_handler m_skybox_frag_shader{};
